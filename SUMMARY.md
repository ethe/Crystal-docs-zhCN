...
* [安装](installation/README.md)
   * [在 Debian 或 Ubuntu](installation/on_debian_and_ubuntu.md)
   * [在 RedHat 或 CentOS](installation/on_redhat_and_centos.md)
   * [在 Arch Linux](installation/on_arch_linux.md)
   * [在 Mac OSX 使用 Homebrew](installation/on_mac_osx_using_homebrew.md)
   * [从 tar.gz 打包](installation/from_a_targz.md)
   * [编译源码](installation/from_source_repository.md)
...
* [语法和语义](syntax_and_semantics/README.md)
   ...
   * [文本](syntax_and_semantics/literals.md)
       * [Nil](syntax_and_semantics/literals/nil.md)
       * [布尔型 (Bool)](syntax_and_semantics/literals/bool.md)
       * [整型 (Integers)](syntax_and_semantics/literals/integers.md)
       * [浮点型 (Floats)](syntax_and_semantics/literals/floats.md)
       * [字符型 (Char)](syntax_and_semantics/literals/char.md)
